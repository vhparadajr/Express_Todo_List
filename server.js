...
MongoClient.connect('mongodb://derp:derp111@ds127811.mlab.com:27811/todo_list', (err, database) => {
...
app.delete('/deleteall', (req, res) => {
  console.log("working?????")
  db.collection('messages').findOneAndDelete({wholeList:req.body.wholeList}, (err, result) => {
    console.log('messages');
    console.log(req.body.wholeList)
    if (err) return res.send(500, err)
    res.send('Message deleted!')
  })
})
